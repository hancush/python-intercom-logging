...
setup(
    ...
    keywords='intercom_logging',
    name='intercom_logging',
    packages=find_packages(include=['intercom_logging']),
    setup_requires=setup_requirements,
    test_suite='tests',
    tests_require=test_requirements,
    url='https://github.com/hancush/python-intercom-logging',
    version='0.1.0',
    zip_safe=False,
)
